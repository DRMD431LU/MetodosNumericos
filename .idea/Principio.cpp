...
//**************************
//se crea menu, se pide entrada de usuario
void Tema() {
    int x;
    system("cls");
...
//*****************************
//se define la funcion Sen que es el menu para sistemas de ecuaciones lineales de
//una sola variable
void Sen() {
    int x;
...
//***********************************************************+
//se define la funcion VVP que es el menu para la operacion de valores y vectores propios
void Vvp() {
    int x;
...
//*************************************************
//se define la funcion para el menu de biseccion
